  ...
  return (
    <div className="min-h-screen flex flex-col bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col max-w-4xl mx-auto w-full p-4">
        ...
        >
          <h1 className={`text-3xl font-bold text-red-500 ${glitch ? 'mix-blend-difference' : ''}`}>
            غرفة الظلام
          </h1>
          <p className="text-red-300/60 text-sm mt-2">للخروج... اكتب "استسلام" إن جبنت... 👹</p>
        </motion.div>

        <div className="flex-1 overflow-y-auto py-6 space-y-4 scrollbar-thin scrollbar-thumb-red-900 scrollbar-track-black">
          <AnimatePresence>
        ...
        >
          <div className="flex gap-2">
            <Input
              ...
              className="bg-gray-900/50 border-red-900/30 text-white placeholder:text-gray-600 focus:border-red-600"
              disabled={isTyping}
            />
            <Button
