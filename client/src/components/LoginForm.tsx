        ...
        <Card className="w-full shadow-2xl backdrop-blur-sm bg-black/95 border-red-900/70 border-2 relative overflow-hidden group hover-elevate transition-all duration-500">
          ...
          <CardHeader className="text-center space-y-6 pb-6 relative z-10">
            <div className="flex justify-center">
              <motion.div 
                className="w-28 h-28 rounded-full bg-gradient-to-br from-red-900/40 to-black/40 flex items-center justify-center relative group-hover:scale-110 transition-transform duration-500 border-2 border-red-800/50"
                animate={{
                  boxShadow: [
              ...
              >
                ...
                <Skull className="w-14 h-14 text-red-400 relative z-10" />
                <Flame className="w-6 h-6 text-orange-500 absolute bottom-2 animate-pulse" />
              </motion.div>
            </div>
            <div>
              <motion.div
                ...
                transition={{ duration: 2, repeat: Infinity }}
              >
                <CardTitle className="text-4xl md:text-5xl mb-3 bg-gradient-to-r from-red-400 via-orange-500 to-red-400 bg-clip-text text-transparent" data-testid="text-login-title">
                  ادخل الجحيم
                </CardTitle>
              </motion.div>
              <CardDescription className="text-lg text-red-300/70">
          ...
          <CardContent className="relative z-10 space-y-6">
            <Alert className="border-red-700/70 bg-red-950/40 shadow-lg shadow-red-900/20">
              ...
              <AlertDescription className="text-red-200 text-sm leading-relaxed font-bold flex items-start gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="text-lg border-red-800/50 focus:border-red-600 bg-black/70 text-red-100 placeholder:text-red-900/50 backdrop-blur-sm transition-all duration-300 shadow-inner shadow-red-900/20"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`text-lg ${ageError ? 'border-red-600 focus:border-red-500 shadow-lg shadow-red-600/30' : 'border-red-800/50 focus:border-red-600'} bg-black/70 text-red-100 placeholder:text-red-900/50 backdrop-blur-sm transition-all duration-300 shadow-inner shadow-red-900/20`}
                />
                {ageError && (
                  <motion.p 
              ...
              <div className="space-y-3">
                ...
                <RadioGroup value={gender} onValueChange={(value) => setGender(value as "male" | "female")} className="flex gap-4">
              ...
              <Button
                type="submit"
                className="w-full text-lg relative overflow-hidden group/btn bg-gradient-to-r from-red-900 to-red-800 hover:from-red-800 hover:to-red-700 border-2 border-red-700/50 shadow-lg shadow-red-900/50"
                size="lg"
