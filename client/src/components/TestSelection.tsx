      ...
      <div className="max-w-7xl mx-auto space-y-12 relative z-10">
        ...
        <div className="text-center space-y-8 animate-float">
          ...
          >
            ...
            <motion.h1 
              className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-red-600 via-red-500 to-orange-600 bg-clip-text text-transparent flex items-center justify-center gap-4 flex-wrap mb-4"
            ...
            >
              <Flame className="w-12 h-12 md:w-20 md:h-20 text-orange-500 drop-shadow-[0_0_20px_rgba(249,115,22,0.8)]" />
          ...
          {/* Warning box */}
          <motion.div
            className="max-w-3xl mx-auto bg-black/80 border-2 border-red-900 rounded-lg p-6 backdrop-blur-sm"
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              <h2 className="text-2xl font-bold text-red-400">تحذير من الجحيم</h2>
              <AlertTriangle className="w-8 h-8 text-red-500 animate-pulse" />
            </div>
                  ...
                  >
                    {isDemonChat ? (
                      ...
                      >
                        ...
                        <div className="grid md:grid-cols-2 gap-8 p-10 relative z-10">
                          ...
                          <div className="flex flex-col justify-center space-y-6">
                            <motion.div
                              ...
                              transition={{ duration: 2, repeat: Infinity }}
                            >
                              <CardTitle className="text-4xl md:text-6xl bg-gradient-to-r from-red-500 via-orange-500 to-red-500 bg-clip-text text-transparent font-bold text-center md:text-right mb-4">
                                {test.name}
                              </CardTitle>
                            </motion.div>
                            
                            <CardDescription className="text-xl leading-relaxed text-red-100/90 text-center md:text-right font-semibold">
                              {test.description}
                            </CardDescription>
                            ...
                            >
                              <Button
                                className="w-full text-xl py-8 relative overflow-hidden bg-gradient-to-r from-red-900 via-red-700 to-red-900 hover:from-red-800 hover:via-red-600 hover:to-red-800 border-4 border-orange-600 text-white font-bold shadow-[0_0_30px_rgba(249,115,22,0.6)] group/btn"
                                onClick={(e) => {
                                  e.stopPropagation();
                  ...
                  >
                    ...
                    >
                      ...
                      <CardHeader className="space-y-6 relative z-10">
                        ...
                        >
                          <motion.div 
                            className={`w-24 h-24 rounded-full bg-gradient-to-br ${theme.iconBg} flex items-center justify-center relative border-3 ${theme.border}`}
                            animate={{
                              boxShadow: [
                          ...
                          >
                            ...
                            <Icon className="w-12 h-12 text-red-400 relative z-10 drop-shadow-[0_0_10px_rgba(220,38,38,0.8)]" />
                          </motion.div>
                        </motion.div>
                        
                        <CardTitle className={`text-center text-2xl bg-gradient-to-r ${theme.textGradient} bg-clip-text text-transparent group-hover:scale-105 transition-all duration-300 font-bold drop-shadow-[0_0_10px_rgba(220,38,38,0.3)]`}>
                          {test.name}
                        </CardTitle>
                        
                        <CardDescription className="text-center text-base leading-relaxed min-h-[60px] text-red-100/80 font-medium">
                          {test.description}
                        </CardDescription>
                      </CardHeader>
                      ...
                      <CardContent className="flex flex-col gap-4 relative z-10">
                        <div className="text-center">
                          <span className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r ${theme.gradient} text-sm border-2 ${theme.border} text-red-100 font-bold shadow-[0_0_15px_rgba(220,38,38,0.4)]`}>
                        ...
                        >
                          <Button
                            className={`w-full group/btn relative overflow-hidden bg-gradient-to-r from-red-900 to-red-800 hover:from-red-800 hover:to-red-700 border-3 ${theme.border} text-red-100 font-bold shadow-[0_0_20px_rgba(220,38,38,0.4)]`}
                            onClick={(e) => {
                              e.stopPropagation();
                              onSelectTest(key as TestTypeId);
                            }}
