        ...
        <div className="animate-float">
          <Card className="flex-1 flex flex-col shadow-2xl backdrop-blur-sm bg-card/90 border-primary/20 relative overflow-hidden group">
            ...
            <CardContent className="p-8 md:p-12 flex flex-col justify-center flex-1 relative z-10">
              <h2 className="text-2xl md:text-3xl font-semibold text-center mb-12 bg-gradient-to-r from-purple-200 to-violet-200 bg-clip-text text-transparent" data-testid="text-question">
                {question.text}
              </h2>
              ...
              <div className="space-y-3">
                {answerOptions.map((option, index) => (
                  ...
                  >
                    <Button
                      variant="outline"
                      className="w-full h-auto py-5 px-6 text-lg justify-start hover-elevate active-elevate-2 border-primary/20 transition-all duration-300 group/btn relative overflow-hidden"
                    ...
                    >
                      ...
                      <span className="font-mono text-primary ml-4 relative z-10">{option.value}</span>
